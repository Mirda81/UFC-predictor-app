...
def get_proba(app, fighter1, fighter2):
    ...
    if pred1 > pred2:
        app.label_pred_value2.config(foreground="black")
        app.label_pred_value1.config(foreground="#00FF00")
    if pred2 > pred1:
        app.label_pred_value1.config(foreground="black")
        app.label_pred_value2.config(foreground="#00FF00")

    probability_chart(app, pred1, pred2)
    app.label_pred_value1.config(text=str(pred1) + ' %')
    app.label_pred_value2.config(text=str(pred2) + ' %')
